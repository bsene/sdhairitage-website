...
function initDatepickers($, data) {
    $(".sln_datepicker div").each(function() {
        ...
        if ($(this).hasClass("started")) {
            ...
            datetimepicker.setDate(suggestedDate);
...
function sln_renderAvailableTimeslots($, data) {
    ...
    setTimeout(() => {
        ...
        //         return;
        //     }
        //     var datetimepicker = $(".sln_datepicker div").data("datetimepicker");

        //     var date = $(this).attr("data-ymd");

        //     var dateObj = $.fn.datetimepicker.DPGlobal.parseDate(date,
        //         datetimepicker.format,
        //         datetimepicker.language,
        //         datetimepicker.formatType);
        ...
        //         datetimepicker.formatType
        //     );
        //     var dateString = dateObj.toLocaleDateString(datetimepicker.language,
